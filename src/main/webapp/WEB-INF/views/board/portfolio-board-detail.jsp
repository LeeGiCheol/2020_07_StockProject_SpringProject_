				...
				<div class="col-md-2">
					<div class="sidebar sticky" id="cssmenu" style="position: relative;">
						<ul>	
							...
							<li class="selected mid"><a href="/board/portfolio"><span>포트폴리오</span></a></li>
...
>>>>>>> parent of afc747a... 포트폴리오 링크 수정, 모든 게시판 이전글 다음글에 공지는 안들어가게 함, 자유게시판에서 공지사항 볼 경우 이전글 다음글은 안나오게 함
