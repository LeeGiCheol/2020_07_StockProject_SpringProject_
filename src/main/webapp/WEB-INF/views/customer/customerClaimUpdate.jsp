				...
				<div class="col-md-2">
					...
					<div class="col-md-10">
						...
						<div class="m-drop-down">
							...
							<form name="form" id="form" role="form" method="POST" action="/customerClaim/update">
											...
											<tr>
												...
												<td>
													<span class="input-style-case02">
														<input type="text" id="title" name="qtitle" value="${qna.qtitle}" maxlength="250">
...
<!-- 								               <div class="mb-3 title">
								            ...
								            <tr>
												<th scope="row">내용</th>
												<td>
													<textarea class="form-control" rows="5" name="qcontent" id="bcontent" placeholder="내용을 입력해 주세요" rows="30" style="width:100%;">${qna.qcontent}</textarea>
												</td>
											</tr>
								...
								<div class="bt-area">
									<a href="/customerClaim/list"  class="moreBttn left norm"">취소</a>
