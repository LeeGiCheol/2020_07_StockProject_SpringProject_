			...
			<div class="t-search-box">
				...
				<div class="tab-area swiper-container swiper-container-horizontal" style="cursor: grab;">
					<ul class="tab-st01 num07 swiper-wrapper" style="width: auto;">
						...
						<li class="selected swiper-slide"><a href="/total-search/portfolio?keyword=${keyword}" style="width: 100%; border-right: none;">포트폴리오</a></li>
						<li class="swiper-slide"><a href="/total-search/user?keyword=${keyword}" style="width: 100%;">회원</a></li>
					</ul>
				</div> 
				...
				<div>
					<div class="heading-wrap">
						...
						<p>
							<button type="button" onclick="location.href='/total-search/portfolio?keyword=${keyword}'">
								최신순 <i>▼</i>
							</button>
							<button type="button" onclick="location.href='/total-search/portfolio/detail/best?keyword=${keyword}'">
								좋아요 <i>▼</i>
							</button>
						</p>
					</div>
				...
				<div class="more">
					<p><a href="/board/portfolio" class="link-btn tyb">포트폴리오 더보기<i class="fas fa-angle-right"></i></a></p>
				</div>
			</div>
		</div>
