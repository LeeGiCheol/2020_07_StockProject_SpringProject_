	...
	<div class="cont-area log"> 
		<div class="login-wrap"> 
			...
			<div class="social-login">
				...
				<button type="button" class="kakaologin btn-b kakaotalk" onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=411ad5d7607a5206006f889840ab2b27&redirect_uri=http://106.240.16.163:8080/kakao&response_type=code'">카카오톡 아이디로 로그인</button>
			</div>
		</div>
	</div><!-- //cont-area -->	 
</div><!-- //contents -->  
