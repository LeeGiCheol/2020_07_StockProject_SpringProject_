									...
									<table>
										<tbody>
											<tr>
												...
												<td>
													<span class="input-style-case02">
														<input type="text" id="title" name="question" placeholder="질문을 입력하세요" value="" maxlength="250">
								            ...
								            <tr>
												...
												<td>
													<textarea class="form-control" rows="5" name="answer" id="content" placeholder="답변을 입력해 주세요"></textarea>
												</td>
											</tr>
