...
public class StockVO {
	...
	public String toString() {
		return "StockVO [tno=" + tno + ", uno=" + uno + ", rPrice=" + rPrice + ", quantity=" + quantity + ", tprice="
				+ tprice + ", avgprice=" + avgprice + ", newPrice=" + newPrice + ", newQuantity=" + newQuantity
				+ ", stockCode=" + stockCode + ", stockName=" + stockName + ", id=" + id + ", category=" + category
				+ ", tdatetime=" + tdatetime + ", buysell=" + buysell + ", modifyALL=" + modifyALL + "]";
	}
