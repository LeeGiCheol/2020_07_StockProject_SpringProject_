...
<link rel="stylesheet" href="/resources/css/mypageforgetpage.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.2/css/all.min.css">
...
<body class="member">
	...
	<div class="containerNew">
				...
				<div class="col-md-2">
					<div class="sidebar sticky" id="cssmenu" style="position: relative;">
						<ul>
							...
							<li class="selected mid"><a href="/mypageUpdatePassword"><span>비밀번호 변경</span></a></li>
		...
		<div class="col-md-10">			
			<div class="cont-area">
						<div class="drop-nav">
							<h1 class="tit-h1 line">비밀번호 변경</h1>
						</div>
						<div class="m-drop-nav">
							<h1 class="m-drop-tit-title line" style="cursor: pointer;">비밀번호 변경 ▼</h1>
						</div>
